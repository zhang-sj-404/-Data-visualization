                ...
                if(obj.code==8001){
                    ...
                    $(obj.obj.list).each(function (index,item) {
                        ...
                        var str = "<tr>\n" +
                            ...
                            "                                        <td><a class=\"edit\" href=\"javascript:addInfo("+item.h_id+");\">收藏</a></td>\n"+
                            "                                    </tr>";
                        $("#tbody").append(str);
                    })
...
<%--收藏--%>
<script>
    function addInfo(h_id) {
        if(u_name!=null&&u_name!=undefined)
        {
            if(confirm("确定要收藏这条信息吗"))
            {
                $.ajax({
                    url:"/shoucang/findInfo",
                    type:"post",
                    dataType:"json",
                    data:{
                        "s_house":h_id,
                        "s_city":city_location_url,
                        "s_user":u_id,
                    },
                    success:function (obj) {
                        if(obj.code==6001){
