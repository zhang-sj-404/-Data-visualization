...
<script>
    findByPage1(1);
    function findByPage1(currentPage){
        $("#tbody").empty();
        $("#tfoot").empty();
        $.ajax({
            url:"/house/getAllHouseByPage",
            type:"post",
            data:{
                ...
                if(obj.code==8001){
                    ...
                    $(obj.obj.list).each(function (index,item) {
                        ...
                        var str = "<tr>\n" +
                            ...
                            "                                        <td><a href=\""+item.h_url+"\" target=\"view_window\">详情</a></td>\n" +
                            "                                        <td><a class=\"edit\" href=\"javascript:deleteInfo("+item.h_id+");\">删除</a></td>\n"+
                            "                                    </tr>";
                        $("#tbody").append(str);
                    })
                    ...
                    var pageInfo=
                        "\t\t\t<tr align=\"center\">\n" +
                        "\t\t\t\t<td colspan=\"15\">\n" +
                        "\t\t\t\t\t<button onclick=\"tofindByPage1(1)\">首页</button>&nbsp;&nbsp;&nbsp;\n" +
                        "\t\t\t\t\t<button onclick=\"tofindByPage1("+obj.obj.prePage+")\">上一页</button>&nbsp;&nbsp;&nbsp;\n" +
                        "\t\t\t\t\t<button onclick=\"tofindByPage1("+obj.obj.nextPage+")\">下一页</button>&nbsp;&nbsp;&nbsp;\n" +
                        "\t\t\t\t\t<button onclick=\"tofindByPage1("+obj.obj.pages+")\">末页</button>&nbsp;&nbsp;&nbsp;\n" +
                        "\t\t\t\t</td>\n" +
                        "\t\t\t</tr>";
...
<%--删除--%>
<script>
    function deleteInfo(h_id) {
        // console.log(h_id);
        $.ajax({
            url:"/house/deleteInfo",
            type:"post",
            dataType:"json",
            data:{
                "city_location_url":city_location_url,
